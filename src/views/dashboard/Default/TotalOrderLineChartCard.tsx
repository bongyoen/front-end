                        ...
                        <Grid container direction="column">
                            ...
                            <Grid item sx={{mb: 0.75}}>
                                <Grid container alignItems="center">
                                    ...
                                    <Grid item xs={6}>
                                        {timeValue ?
                                            <ApexCharts type={"line"} height={ChartDataMonth.height}
                                                   series={ChartDataMonth.series}
                                                   options={ChartDataMonth.options}/> :
                                            <ApexCharts type={"line"} options={ChartDataYear.options}
                                                   series={ChartDataYear.series} height={ChartDataYear.height}/>}
                                    </Grid>
                                </Grid>
                            </Grid>
                        </Grid>
